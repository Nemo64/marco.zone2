...
$$('article.post-list__item').map(post => ({
  "@type": "TechArticle",
  name: post.querySelector('h2').textContent.trim(),
...
export const loadOldPosts: FeedLoader = async () => [
  {
    "@type": "TechArticle",
    name: "Share an Aurora Serveless between services using CloudFormation",
  ...
  {
    "@type": "TechArticle",
    name: "Configure https for the official docker php apache images",
  ...
  {
    "@type": "TechArticle",
    name: "Configure symfony for a serverless lambda environment in bref",
  ...
  {
    "@type": "TechArticle",
    name: "Static resource distribution on a aws serverless multipage application",
  ...
  {
    "@type": "TechArticle",
    name: "Docker for mac uses over 100% cpu while doing nothing",
  ...
  {
    "@type": "TechArticle",
    name: "TYPO3 Css/Js-Spam verhindern",
  ...
  {
    "@type": "TechArticle",
    name: "TYPO3 Erweiterungs Wunschliste",
  ...
  {
    "@type": "TechArticle",
    name: "Formular-Finisher zum TYPO3 Backend-Editor hinzufügen",
  ...
  {
    "@type": "TechArticle",
    name: "Composer und Bower über Docker ausführen",
  ...
  {
    "@type": "TechArticle",
    name: "Jira Performance optimieren durch AdBlock",
  ...
  {
    "@type": "TechArticle",
    name: 'MacBook Pro 13" (2016) Bildschirm Rant',
  ...
  {
    "@type": "TechArticle",
    name: "HTML Bilder in Responsive Websites",
  ...
  {
    "@type": "TechArticle",
    name: "Progressiver HTML Blocksatz mit Silbentrennung",
  ...
  {
    "@type": "TechArticle",
    name: "Ein Blog mit Jekyll und Gulp",
